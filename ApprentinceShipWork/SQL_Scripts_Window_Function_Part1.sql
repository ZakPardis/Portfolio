...
/* **************
   Video Summary
 ************** */
-- To better explain the Window function I will use them with Aggregate functions

select * from employee;

-- ?
SELECT MAX(Salary) FROM Employee; -- will give me maximum salary from the employee table
...
-- Now if i want to display maximum salary corresponding for each department then I need to partition by the department within the over function.
select e.*,
